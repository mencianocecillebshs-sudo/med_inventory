    ...
    <div class="main-content">
        ...
        <div class="quick-action-row">
            <div class="quick-actions">
                <button class="qa-btn" onclick="window.location.href='medicine.php'"><i class="bi bi-plus-circle"></i> Add item</button>
                <button class="qa-btn" onclick="window.location.href='purchases.php'"><i class="bi bi-cart-plus"></i> New purchase order</button>
                <button class="qa-btn" onclick="window.location.href='suppliers.php'"><i class="bi bi-truck"></i> Contact supplier</button>
                <button class="qa-btn" onclick="window.location.href='reports.php'"><i class="bi bi-file-earmark-bar-graph"></i> Generate report</button>
            </div>
        ...
        <div class="kpi-row">
            <div class="kpi-card dashboard-link" id="kpi-sales" data-href="sales.php?period=current_month" role="link" tabindex="0" aria-label="Open this month's sales">
            ...
            <div class="kpi-card dashboard-link" id="kpi-inventory" data-href="medicine.php" role="link" tabindex="0" aria-label="Open inventory">
            ...
            <div class="kpi-card dashboard-link" id="kpi-low-stock" data-href="medicine.php?stock_status=low" role="link" tabindex="0" aria-label="Open low stock inventory">
            ...
            <div class="kpi-card dashboard-link" id="kpi-expiring" data-href="medicine.php?expiry_status=soon" role="link" tabindex="0" aria-label="Open expiring inventory">
            ...
            <div class="kpi-card dashboard-link" id="kpi-pending" data-href="orders.php?status=pending" role="link" tabindex="0" aria-label="Open pending orders">
            ...
            <div>
                ...
                <div class="card">
                    <div class="card-head">
                        ...
                        <a href="user_activity.php" class="link-btn">View log</a>
                    </div>
