...
<body>
                    ...
                    <form id="newPurchaseForm" novalidate>
                        ...
                        <div class="form-section">
                            <div class="form-section-title d-flex justify-content-between align-items-center flex-wrap gap-2">
                                <span id="med-section-title"><i class="bi bi-capsule"></i> Medicine Items</span>
                                <div class="d-flex gap-2 align-items-center flex-wrap">
                                    <div class="btn-group btn-group-sm" role="group" aria-label="Item type picker">
                                        <button type="button" class="btn btn-outline-success active" id="pick-medicine-items-btn">
                                            <i class="bi bi-capsule me-1"></i>Medicine Items
                                        </button>
                                        <button type="button" class="btn btn-outline-success" id="pick-other-products-btn">
                                            <i class="bi bi-box-seam me-1"></i>Other Products
                                        </button>
                                    </div>
                                    <button type="button" class="btn btn-success btn-sm" id="add-med-row-btn" style="border-radius:8px;">
                                        <i class="bi bi-plus-circle me-1"></i> <span id="add-med-row-btn-label">Add Medicine</span>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div style="overflow-x:auto;">
                                <table class="med-items-table">
                                    <thead>
                                        <tr>
                                            <th class="med-picker-cell" id="med-picker-col-header">
    ...
    <script src="assets/js/phar_purchases.js"></script>
</body>
</html>
