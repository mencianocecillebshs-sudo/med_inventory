document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadNotifications(readStatus, page = 1) {
        ...
        let url = `api/phar_notifications.php?read=${readStatus}&search=${encodeURIComponent(search)}&page=${page}&limit=${perPage}`;
    ...
    function handleMarkRead(e) {
        if (e.target.closest('.mark-read-btn')) {
            ...
            fetch(`api/phar_notifications.php?id=${id}`, {
                method: 'PUT',
    ...
    function handleMarkAll(readStatus) {
        ...
        fetch(`api/phar_notifications.php`, {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
