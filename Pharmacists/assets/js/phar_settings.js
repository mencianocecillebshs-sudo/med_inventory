document.addEventListener('DOMContentLoaded', () => {
    ...
    function captureFormData() {
        return {
            ...
            notif_purchase: document.getElementById('notif_purchase').checked ? '1' : '0',
    ...
    function isFormDirty() {
        try {
            ...
            // If any element is missing, be conservative and treat as not dirty
    ...
    function loadSettings() {
        ...
        fetch('api/phar_settings.php', {
            ...
            .then(result => {
                ...
                document.getElementById('notif_purchase').checked = data.notif_purchase != '0';
    ...
    function checkForAlerts() {
        fetch('api/phar_check_alerts.php', {
            method: 'GET',
            credentials: 'same-origin'
        })
    ...
    confirmSaveBtn.addEventListener('click', () => {
        ...
        .then(data => {
            ...
            if (data.error || !data.success) {
                ...
                formChanged = false;
                const systemWideChanged = Object.keys(pendingSaveData).filter(k => originalFormData[k] !== pendingSaveData[k]);
                if (systemWideChanged.length > 0) {
                    setTimeout(() => {
                        showToast('Settings updated system-wide. All pages and roles now use the new values.', 'warning');
                    }, 800);
                }
    ...
    if (resetDefaultsBtn) {
        resetDefaultsBtn.addEventListener('click', () => {
            if (confirm('Are you sure you want to reset all settings to default values?\n\nThis will reset inventory, notification, and system preferences for all pages and roles.')) {
