<?php
if (defined('PHARMACIST_PAGE_HEADER_RENDERED')) {
    return;
}
define('PHARMACIST_PAGE_HEADER_RENDERED', true);

$scriptFile = basename(str_replace('\\', '/', $_SERVER['SCRIPT_NAME'] ?? ''));
$pageKey = preg_replace('/^phar_|\.php$/', '', $scriptFile);

$pageMeta = [
    'dashboard' => ['Dashboard', 'bi-speedometer2'],
    'medicine' => ['Medicines', 'bi-capsule'],
    'purchases' => ['Purchases', 'bi-bag-check'],
...
$navSections = [
    'Inventory' => [
        ['phar_dashboard.php', 'dashboard', 'bi-speedometer2', 'Dashboard'],
        ['phar_medicine.php', 'medicine', 'bi-capsule', 'Medicines'],
        ['phar_purchases.php', 'purchases', 'bi-bag-check', 'Purchases'],
    ],
    'Analytics & Reports' => [
        ['phar_analytics.php', 'analytics', 'bi-graph-up-arrow', 'Analytics'],
        ['phar_reports.php', 'reports', 'bi-file-earmark-bar-graph', 'Reports'],
        ['phar_sales.php', 'sales', 'bi-cart-check', 'Sales'],
    ],
    'System' => [
        ['phar_notifications.php', 'notifications', 'bi-bell', 'Notifications'],
        ['phar_chatbot.php', 'chatbot', 'bi-chat-dots', 'AI Assistant'],
        ['users.php', 'users', 'bi-people', 'Users', true],
        ['user_activity.php', 'user_activity', 'bi-activity', 'User Activity', true],
        ['phar_settings.php', 'settings', 'bi-gear', 'Settings'],
    ],
];
...
<div class="admin-breadcrumb-header" role="navigation" aria-label="Breadcrumb">
    <div class="admin-breadcrumb-shell">
        <div class="admin-breadcrumb-brand">
            ...
            <div>
                <div class="admin-breadcrumb-eyebrow">Pharmacist Workspace</div>
                <ol class="breadcrumb admin-breadcrumb mb-0">
                    <li class="breadcrumb-item">
                        <a href="phar_dashboard.php">
                    ...
                    <li class="breadcrumb-item">
                        <?php if (!$isDashboard) { ?>
                            <a href="phar_dashboard.php">Pharmacist</a>
                        <?php } else { ?>
