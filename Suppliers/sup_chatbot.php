...
$supplier_company = htmlspecialchars((string)($supplier_profile['company'] ?? $supplier_profile['name'] ?? 'Supplier'));
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>AI Assistant - Supplier Workspace</title>
    ...
    <style>
        ...
        .chat-toolbar {
            ...
            background: linear-gradient(135deg, rgba(27, 94, 63, 0.08), rgba(46, 204, 113, 0.05)), #ffffff;
            display: flex;
            align-items: center;
        ...
        .assistant-status-chip.is-private {
            color: #1d4ed8;
        ...
        .chat-container {
            ...
            overflow-y: auto;
            padding: 1.5rem;
            background: linear-gradient(180deg, rgba(248, 250, 252, 0.82), rgba(241, 245, 249, 0.82)), #f8fafc;
            display: flex;
            flex-direction: column;
            gap: 1.25rem;
            min-height: 0 !important;
        ...
        @media (max-width: 991.98px) {
            body.chatbot-page { overflow: auto; }
            body.chatbot-page .main-content {
            ...
            .quick-sidebar { flex: 0 0 auto; width: 100%; }
...
<body class="chatbot-page">
        ...
        <div class="chat-panel flex-grow-1 d-flex flex-column">
            <div class="chat-toolbar">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <strong>Supplier Copilot</strong>
                        <div class="assistant-toolbar-meta">
                            <small class="text-muted"><?php echo $supplier_company; ?></small>
                            <span class="assistant-status-chip is-private"><i class="bi bi-shield-lock"></i> Your data only</span>
                        </div>
                    </div>
                </div>
                <button class="btn btn-outline-secondary btn-sm" id="new-chat-btn" type="button">
            ...
            <div class="assistant-compose">
                <div class="input-row">
                    <input type="text" class="form-control" id="chat-input"
                           placeholder="Ask about your inventory, orders, sales, or transactions..." autocomplete="off">
                    <button class="btn btn-send" id="send-chat-btn" type="button" aria-label="Send">
                        <i class="bi bi-send-fill"></i>
                    </button>
                    <button class="btn btn-outline-secondary btn-voice" id="voice-btn" type="button" aria-label="Voice input">
                        <i class="bi bi-mic"></i>
                    </button>
                </div>
            </div>
    ...
    <script src="assets/js/sup_chatbot.js"></script>
</body>
</html>
